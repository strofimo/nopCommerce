...
namespace Nop.Plugin.Misc.ProductInventory.Services
{
    ...
    {
        private IRepository<StoreProductInventoryFieldRecord> service;
        private IProductService productService;
        public StoreProductInventoryService(IRepository<StoreProductInventoryFieldRecord> service, IProductService productService)
        {
        ...
        public StoreProductInventoryFieldRecord GetByStoreOrDefault(int productId, int storeId)
        {
            var result = this.service.Table.FirstOrDefault(n => n.ProductId == productId && n.StoreId == storeId);
            if (result == null)
            {
                result = new StoreProductInventoryFieldRecord();
        ...
        public void CreateOrUpdate(StoreProductInventoryFieldRecord data)
        {
